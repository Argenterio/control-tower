...
export interface WhatsappMessage {
  ...
  content?: string;
  mediaUrl?: string;
  mediaKind?: "image" | "audio" | "video" | "document" | "sticker"; // categoría semántica del adjunto
  mimeType?: string;       // MIME del adjunto (image/jpeg, audio/ogg, application/pdf, etc.)
  fileName?: string;       // Nombre del archivo guardado en disco (ej: 6b2f...jpg)
...
export interface WhatsappIncomingPayload {
  ...
  mimeType?: string;      // MIME del adjunto (ej: image/jpeg, audio/ogg)
  fileName?: string;
  ...
  mediaKey?: string;      // Base64 del mediaKey de WhatsApp (Evolution API) - para desencriptar media
