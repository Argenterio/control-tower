...
const TILE_ESRI_URL = "https://server.arcgisonline.com/ArcGIS/rest/services/Canvas/World_Dark_Gray_Base/MapServer/tile/{z}/{y}/{x}";
const TILE_ESRI_ATTR = '&copy; Esri &mdash; Esri, DeLorme, NAVTEQ &copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors';
const TILE_CARTO_URL = "https://{s}.basemaps.cartocdn.com/rastertiles/dark_all/{z}/{x}/{y}.png";
const TILE_CARTO_ATTR = '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> &copy; <a href="https://carto.com/attributions">CARTO</a>';
const ENV = (import.meta as any).env || {};
const TILE_FALLBACK_URL = TILE_OSM_URL;
const TILE_FALLBACK_ATTR = TILE_OSM_ATTR;
const TILE_PRIMARY_URL = ENV.VITE_MAP_TILES_URL || (ENV.VITE_CARTO_API_KEY ? `${TILE_CARTO_URL}?key=${ENV.VITE_CARTO_API_KEY}` : TILE_ESRI_URL);
const TILE_PRIMARY_ATTR = ENV.VITE_MAP_ATTRIBUTION || (ENV.VITE_CARTO_API_KEY ? TILE_CARTO_ATTR : TILE_ESRI_ATTR);
...
export default function MapPage() {
  ...
  const [tileUrl, setTileUrl] = useState(TILE_PRIMARY_URL);
  const [tileAttr, setTileAttr] = useState(TILE_PRIMARY_ATTR);
      ...
      <div className="map-container">
        ...
        >
          <TileLayer
            ...
            eventHandlers={{
              tileerror: () => {
                if (tileUrl !== TILE_ESRI_URL && tileUrl !== TILE_FALLBACK_URL) {
                  setTileUrl(TILE_ESRI_URL);
                  setTileAttr(TILE_ESRI_ATTR);
                } else if (tileUrl === TILE_ESRI_URL) {
                  setTileUrl(TILE_FALLBACK_URL);
                  setTileAttr(TILE_FALLBACK_ATTR);
                }
              }
            }}
          />
